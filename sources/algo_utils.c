...
/*   Updated: 2021/09/10 00:09:24 by kali             ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void    four_ints(int *a_stack, int *b_stack, t_data *data)
{
    ...
    if (a_stack[3] == 1)
        ...
        while (a_stack[0] != 1)
            rotate(a_stack, data, "rra\n");
    //??
    push(a_stack, b_stack, data, "pb\n");
    if (ft_is_sorted(a_stack, data) == EXIT_SUCCESS)
...
void    five_int_2(int *a_stack, int *b_stack, t_data *data)
{
    if (ft_is_sorted(a_stack, data) == EXIT_SUCCESS)
        three_ints(a_stack, data);
    push(b_stack, a_stack, data, "pa\n");
